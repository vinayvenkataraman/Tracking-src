...
class Motion:
    ...
    def __init__(self):                  
                    ...
                    self.inname= 'Input.mp4'
    
                    #file name to save
                    self.outname = "C:\\Users\\njagdale\Documents\\Visual Studio 2015\\Projects\\HeatMap"
    ...
    def run(self):
        cap = cv2.VideoCapture(self.inname)
        fgbg = cv2.createBackgroundSubtractorMOG2(history=500, varThreshold=5,detectShadows=False)
    ...
    def write(self):
        ...
        #cv2.imshow('heatmap_background', backg)
